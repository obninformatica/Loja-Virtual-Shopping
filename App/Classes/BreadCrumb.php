...
//      breadcrumb para busca
        if(substr_count($this->uri, '?') > 0)
        {
            ...
            return "<span style='color:#000;'>Navegação&nbsp;</span><span style='font-style: italic;color: #00aced'><a href='/' style='text-decoration: none;color: #00aced;'>Inicio</a>".str_replace('+','-',$explodeIgual[1]).(ltrim($this->uri. '/'))."</span>";
        }
